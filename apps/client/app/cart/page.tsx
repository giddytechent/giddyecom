    ...
    return (
        <div className="flex flex-col gap-8 items-center mt-12">
            ...
            <div className="w-full flex flex-col lg:flex-row gap-16">
                {/* STEPS  */}
                <div className="w-full lg:w-7/12 shadow-lg border border-gray-100 p-8 rounded-lg flex-col gap-8">
                    {activeStep === 1 ? (
                        cart.map(item => (
                            // SINGLE CART ITEM
                            <div className="flex items-center justify-between py-2 mb-2" key={item.id+item.selectedSize+item.selectedColor}>
                                {/* IMAGE & DETAILS  */}
                ...
                <div className="w-full lg:w-5/12 shadow-lg border border-gray-100 p-8 rounded-lg flex-col gap-8 h-max">
                    ...
                    {activeStep === 1 &&
                        <button
                            ...
                            className="w-full bg-gray-800 hover:bg-gray-600 transition-all duration-300 text-white p-2 rounded-lg cursor-pointer flex items-center justify-center gap-2">
                            Continue
